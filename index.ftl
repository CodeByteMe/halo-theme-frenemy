...
<@layout title="${options.blog_title!}" keywords="${options.seo_keywords!}" description="${options.seo_description!}" bodyClass="home-template">
  <section class="site-hero responsive-title-img" style="background-image: url('${settings.index_cover!'${static}/assets/images/hero-background.jpg'}');">
    <div class="container">
      <div class="hero-content">
        <h1 class="site-name">${options.blog_title!}</h1>
          ...
          <nav aria-label="文章分页">
            <ul class="pagination">
              <#if posts.hasPrevious()>
                <#if posts.number == 1>
                  <li class="page-item">
                    <a class="page-link" href="${context!}/" aria-label="上一页">
              ...
              <#list rainbow as r>
                ...
                <#else>
                  <li class="page-item"><a class="page-link" href="${context!}/page/${r}">${r}</a></li>
                </#if>
              </#list>
              <#if posts.hasNext()>
                <li class="page-item">
